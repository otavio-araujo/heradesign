...
<body class="bg-gray-50 px-6 py-6">

    <table class="w-full bg-gray-300 h-16" >
        <thead>
            <th>Teste</th>
        </thead>
        <tbody>
    ...
    {{-- <main>
        <div
            class="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4 col-span-12 2xl:col-start-3 2xl:col-span-8 md:mx-6 lg:my-6">
            <div class="overflow-hidden p-4 space-y-6">
                <div class="sm:flex">
                    ...
                    <div class="space-y-3 text-left sm:ml-auto sm:text-right">
                        <svg class="w-10 h-10 sm:ml-auto" viewBox="0 0 39 46" fill="none"
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="text-gray-900 bg-white">
                                        <tr>
                                            ...
                                            <td
                                                class="p-4 text-base font-normal text-gray-500 whitespace-nowrap">
                                                $128.00
                                            </td>
                                            <td
                                                class="p-4 text-base font-semibold text-gray-900 whitespace-nowrap">
                                                1
                                            </td>
